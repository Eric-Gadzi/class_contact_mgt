...
<body>
    <h1>ADD A CONTACT</h1>
    <form class="form-floating" action="../actions/addContact.php" method = "POST">
        <div class="form-floating mb-3">
            <input type="text" class="form-control" name = "name" id="floatingInput" placeholder="eg: John Doe">
